...
class Naver_person(models.Model):
    ...
    Answer          = models.TextField(max_length=500, blank=True, null=True, verbose_name='답변')
    question_ID     = models.CharField(max_length=50, blank=True, null=True, verbose_name='질문자 아이디') 
    answer_ID       = models.CharField(max_length=50, blank=True, null=True, verbose_name='답변자 아아디') 
    ...
    naver_url       = models.URLField(blank=True, null=True, verbose_name='지식인 URL')
    creat_at        = models.DateTimeField(auto_now_add=True, blank=True, null=True, verbose_name='작성일')
