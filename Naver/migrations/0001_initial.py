    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "Answer",
                    models.TextField(max_length=500, null=True, verbose_name="답변"),
                ),
                (
                    "question_ID",
                    models.CharField(max_length=50, null=True, verbose_name="질문자 아이디"),
                ),
                (
                    "answer_ID",
                    models.CharField(max_length=50, null=True, verbose_name="답변자 아아디"),
                ),
                (
                    "question_status",
                    models.CharField(
